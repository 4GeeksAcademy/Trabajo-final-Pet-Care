...
class Raza(db.Model):
    ...
    mascotas: Mapped[list["Pet"]] = relationship("Pet", back_populates="raza")
...
class Pet(db.Model):
    ...
    raza_id: Mapped[int] = mapped_column(db.ForeignKey("razas.id"), nullable=True)
    vacunas: Mapped[list["Vacuna"]] = relationship("Vacuna", back_populates="mascota")


    # Relación ➜ cada mascota "apunta" a una raza
    raza: Mapped["Raza"] = relationship("Raza", back_populates="mascotas")
